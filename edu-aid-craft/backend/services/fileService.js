...
function addTitleSlide(pptx, title, disability, theme) {
  ...
  // AdptLearn branding band
  s.addShape(pptx.ShapeType.rect, { x: 0, y: 0, w: '100%', h: 1.1, fill: { color: '000000', transparency: 87 } });
  s.addText('AdptLearn', {
  ...
  const subtitle = disability === 'Dyslexia'
    ? 'Dyslexia-friendly format  •  Large text  •  Extra spacing  •  AdptLearn'
    : `${disability}-adapted material  •  Generated by AdptLearn`;
  s.addText(subtitle, {
...
function addDyslexiaSlide(pptx, slideObj, idx, totalSlides, theme) {
  ...
  s.addText('AdptLearn  •  Dyslexia-friendly format  •  Verdana 20pt  •  1.8× spacing', {
...
function addDefaultSlide(pptx, slideObj, idx, totalSlides, theme, disability) {
  ...
  s.addText('AdptLearn – Adaptive Learning Platform', {
...
function addADHDSlide(pptx, slideObj, idx, totalSlides, theme) {
  ...
  s.addText(`${icon}  AdptLearn – ADHD-optimized  •  Color-coded section: ${colorTag}`, {
